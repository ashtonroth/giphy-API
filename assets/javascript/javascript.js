$( document ).ready(function() {
    ...
    var emotions = ["Happy", "Sad", "Timid", "Annoyed", "Bored", "Romantic", "Giggly", ];
    ...
    function displayGifs(){
        var newEmotion = $(this).attr("data-name");
    ...
    displayGifButtons(); // displays list of emotions already created
    addNewButton();
    removeLastButton();
